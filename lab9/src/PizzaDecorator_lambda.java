...
public class PizzaDecorator_lambda {

    interface Pizza{
        public String bakePizza();
    }
    public PizzaDecorator_lambda (){}
...
//
        Pizza BasicPizza = () -> ("basic pizza");
        Pizza PizzaDecorator = () -> (BasicPizza.bakePizza());
        Pizza ChickenPizza = () -> (PizzaDecorator.bakePizza() + " with chicken topping on");
